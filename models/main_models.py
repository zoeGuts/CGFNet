...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, stride=1, downsample=None, 
        ...
        self.cbam = CBAM(out_channel) if att_type == 'CBAM' else None
        self.clam = CLAM(out_channel, reduction_ratio=16) if att_type == 'MBLANet' else None
        if att_type == 'ours': 
            cls_name = 'GGAM'
